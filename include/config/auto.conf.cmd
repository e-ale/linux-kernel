...
ifneq "$(KERNELVERSION)" "4.18.9"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "gcc (Ubuntu 5.5.0-12ubuntu1~14.04) 5.5.0 20171010"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "/home/pidge/e-ale-poky/build/tmp/work-shared/beaglebone-yocto/kernel-source"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "gcc"
include/config/auto.conf: FORCE
